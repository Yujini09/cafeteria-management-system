            ...
            @if(Auth::user()->role === 'customer')
                <div x-data="paymentPrompt({
                    ...
                    <div x-show="open"
                        ...
                        <div class="w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 sm:p-8">
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Payment Required</h2>
                            ...
                            <div class="mt-4 p-4 rounded-lg bg-emerald-50 border border-emerald-100">
                                <div class="text-xs uppercase tracking-wide text-emerald-700">Amount Due</div>
                                <div class="text-2xl font-bold text-clsu-green" x-text="formattedAmount"></div>
                            </div>
                            ...
                            <form method="POST"
                                ...
                                <div>
                                    <label for="payment_reference_number" class="block text-sm font-semibold text-gray-700">Reference Number</label>
                                ...
                                <div>
                                    <label for="payment_department_office" class="block text-sm font-semibold text-gray-700">Department/Office</label>
                                ...
                                <div>
                                    <label for="payment_payer_name" class="block text-sm font-semibold text-gray-700">Name</label>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-2">
                                    <a :href="actionUrl" class="text-sm text-gray-500 hover:text-gray-700">Open full payment page</a>
                                    <button type="submit"
                                            class="inline-flex items-center justify-center px-6 py-3 bg-clsu-green text-white rounded-lg hover:bg-green-700 transition font-semibold">
                                        Submit for Review
                                    </button>
                                </div>
                            </form>
