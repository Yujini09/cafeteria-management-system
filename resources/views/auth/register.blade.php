            ...
            <div class="relative w-full overflow-x-hidden bg-green-100 px-5 py-6 sm:px-6 sm:py-8 md:w-7/12 md:px-8 md:pt-10 md:pb-12 lg:h-full lg:overflow-y-auto lg:px-12 lg:pt-12 lg:pb-20"> 
                ...
                <div class="relative z-10 flex h-full flex-col">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="registerForm" class="flex flex-col gap-5">
                        ...
                        <div>
                            <label for="email" class="text-admin-neutral-700 font-medium block">Email <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <x-text-input id="email" name="email" type="email" class="block mt-1 w-full pl-10 h-11 !rounded-admin !shadow-none border border-admin-neutral-300 bg-admin-neutral-50 text-admin-neutral-900 placeholder-admin-neutral-400 focus:border-admin-primary focus:ring-admin-primary/20" required autofocus />
                        ...
                        <div x-data="{ showConfirm: false }">
                            <label for="password_confirmation" class="text-admin-neutral-700 font-medium block">Confirm Password <span class="text-red-500">*</span></label>
                            <div class="relative">
